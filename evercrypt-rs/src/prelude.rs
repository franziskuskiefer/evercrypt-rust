...
pub use crate::aead::{
    self, decrypt as aead_decrypt, decrypt_comb as aead_decrypt_comb, encrypt as aead_encrypt,
    encrypt_comb as aead_encrypt_comb, key_size as aead_key_size, nonce_size as aead_nonce_size,
