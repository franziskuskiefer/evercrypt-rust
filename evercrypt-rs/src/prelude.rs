...
pub use crate::aead::{
    ...
    nonce_gen as aead_nonce_gen, Aead, Error as AeadError, Mode as AeadMode,
};
...
pub use crate::p256::{
    ...
    random_nonce as p256_ecdsa_random_nonce, Error as P256Error, Nonce as P256Nonce, Scalar as P256Scalar,
